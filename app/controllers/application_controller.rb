class ApplicationController < ActionController::Base
  ...
  def update_sanitized_params
    ...
    devise_parameter_sanitizer.for(:accept_invitation) {|u| u.permit(:email, :password, :password_confirmation, :company_name, :phone, :invitation_token, :first_name, :last_name, :location)}
  end
